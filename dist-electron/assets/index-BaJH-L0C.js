...
React$1.forwardRef(({ className, ...props }, ref) => {
...
function Dashboard() {
  return /* @__PURE__ */ React$1.createElement("div", { className: "min-h-screen bg-red-50" }, /* @__PURE__ */ React$1.createElement("header", { className: "bg-red-600 text-white p-6 text-2xl font-bold flex items-center" }, /* @__PURE__ */ React$1.createElement("span", { className: "mr-2" }, "🍜"), " CHIFA IMPERIO - Sistema POS"), /* @__PURE__ */ React$1.createElement("main", { className: "p-6" }, /* @__PURE__ */ React$1.createElement("h2", { className: "text-lg text-red-800 font-semibold mb-4" }, "Panel de Control Principal"), /* @__PURE__ */ React$1.createElement("div", { className: "grid grid-cols-4 gap-4 mb-6" }, /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-4 rounded shadow border-l-4 border-green-500" }, /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-500" }, "Ventas Hoy"), /* @__PURE__ */ React$1.createElement("p", { className: "text-green-600 text-xl font-bold" }, "S/ 1250.50")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-4 rounded shadow border-l-4 border-orange-400" }, /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-500" }, "Pedidos Pendientes"), /* @__PURE__ */ React$1.createElement("p", { className: "text-orange-500 text-xl font-bold" }, "8")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-4 rounded shadow border-l-4 border-blue-400" }, /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-500" }, "Mesas Ocupadas"), /* @__PURE__ */ React$1.createElement("p", { className: "text-blue-500 text-xl font-bold" }, "12/20")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-4 rounded shadow border-l-4 border-red-500" }, /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-500" }, "Inventario Bajo"), /* @__PURE__ */ React$1.createElement("p", { className: "text-red-600 text-xl font-bold" }, "3 items"))), /* @__PURE__ */ React$1.createElement("div", { className: "grid grid-cols-3 gap-6" }, /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-red-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(ShoppingCart, { size: 20 }), " Sistema de Caja"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Procesar ventas, generar tickets y enviar pedidos a cocina"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-red-600 text-white px-4 py-2 rounded w-full" }, "Abrir Caja")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-orange-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(Utensils, { size: 20 }), " Panel de Cocina"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Ver pedidos pendientes y actualizar estados"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-orange-500 text-white px-4 py-2 rounded w-full" }, "Ver Cocina")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-blue-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(Tablet, { size: 20 }), " Tablet Mozos"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Tomar pedidos de mesa y gestionar mesas"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-blue-600 text-white px-4 py-2 rounded w-full" }, "Abrir Tablet")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-green-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(Truck, { size: 20 }), " Delivery"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Gestionar pedidos de delivery y repartidores"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-green-600 text-white px-4 py-2 rounded w-full" }, "Ver Delivery")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-purple-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(Box, { size: 20 }), " Inventario"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Control de insumos y stock de productos"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-purple-600 text-white px-4 py-2 rounded w-full" }, "Ver Inventario")), /* @__PURE__ */ React$1.createElement("div", { className: "bg-white p-5 rounded shadow" }, /* @__PURE__ */ React$1.createElement("h3", { className: "text-xl text-indigo-600 font-semibold flex items-center gap-2" }, /* @__PURE__ */ React$1.createElement(ChartNoAxesColumnIncreasing, { size: 20 }), " Reportes"), /* @__PURE__ */ React$1.createElement("p", { className: "text-sm text-gray-600 mb-3" }, "Reportes de ventas, productos más vendidos"), /* @__PURE__ */ React$1.createElement("button", { className: "bg-indigo-600 text-white px-4 py-2 rounded w-full" }, "Ver Reportes")))));
}
function App() {
  return /* @__PURE__ */ React$1.createElement(Dashboard, null);
}
