...
function App() {
  ...
  if (loading) {
    return /* @__PURE__ */ React.createElement("div", { className: "p-6" }, /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold mb-4" }, "🥢 Menú del Chifa"), /* @__PURE__ */ React.createElement("p", null, "Cargando..."));
  }
  if (error) {
    return /* @__PURE__ */ React.createElement("div", { className: "p-6" }, /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold mb-4" }, "🥢 Menú del Chifa"), /* @__PURE__ */ React.createElement("div", { className: "bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded" }, /* @__PURE__ */ React.createElement("p", null, /* @__PURE__ */ React.createElement("strong", null, "Error:"), " ", error), /* @__PURE__ */ React.createElement("p", { className: "text-sm mt-2" }, "Revisa la consola de DevTools para más detalles")));
  }
  return /* @__PURE__ */ React.createElement("div", { className: "p-6 max-w-4xl mx-auto" }, /* @__PURE__ */ React.createElement("h1", { className: "text-3xl font-bold text-center mb-6 text-red-600" }, "🥢 Menú del Chifa"), /* @__PURE__ */ React.createElement("h2", { className: "text-xl font-semibold mb-4" }, "Platos Principales"), productos.length === 0 ? /* @__PURE__ */ React.createElement("p", { className: "text-gray-500" }, "No se encontraron productos") : /* @__PURE__ */ React.createElement("div", { className: "grid gap-4 md:grid-cols-2 lg:grid-cols-3" }, productos.map((item) => /* @__PURE__ */ React.createElement("div", { key: item.id, className: "bg-white border border-gray-200 rounded-lg p-4 shadow-sm hover:shadow-md transition-shadow" }, /* @__PURE__ */ React.createElement("h3", { className: "font-semibold text-lg text-gray-800" }, item.nombre), item.descripcion && /* @__PURE__ */ React.createElement("p", { className: "text-gray-600 text-sm mt-1" }, item.descripcion), /* @__PURE__ */ React.createElement("p", { className: "text-red-600 font-bold text-xl mt-2" }, "S/. ", item.precio.toFixed(2)), /* @__PURE__ */ React.createElement("button", { className: "mt-3 w-full bg-green-600 text-white py-2 px-4 rounded hover:bg-red-700 transition-colors cursor-pointer" }, "Agregar al Pedido")))), /* @__PURE__ */ React.createElement("div", { className: "mt-8 text-center text-gray-500" }, /* @__PURE__ */ React.createElement("p", null, "Total de productos: ", productos.length)));
}
